...
namespace p
{
	 ...
	 */
	//	@SuppressWarnings("deprecation")
		public bool copyFile(int resourceId,String folder){
			try{
				if(resourceId != 0){
		...
		// @SuppressWarnings("deprecation")
		public bool copyXmlFile(int resourceId,String folder){
			try{
				if(resourceId != 0){
		...
		// @SuppressWarnings("deprecation")
		public boolcopyHtmlFile(int resourceId,String folder){
			try{
				if(resourceId != 0){
		...
		// @SuppressWarnings("deprecation")
		public bool copyCssFile(int resourceId,String folder){
			try{
				if(resourceId != 0){
	 ...
	 */
		...
		// @SuppressWarnings("deprecation")
		public bool writeFiletoPhone(String filename,String content){
			try{
